...
All of this can be quite useful for code and many other creative persuits. Once you know how to use Git, it can be helpful for many things you might want to do (not just course work). 
...
When a repository is created with GitHub, it’s stored remotely in the cloud (i.e., some computers connected to the internet). You can clone a repository to create a local copy on your computer and then use Git to sync the two. This makes it easier to fix issues, add or remove files, and push larger commits. You can also use the editing tool of your choice as opposed to the GitHub UI. Cloning a repository also pulls down all the repository data that GitHub has at that point in time, including all versions of every file and folder for the project! This can be helpful if you experiment with your project and then realize you liked a previous version more. 
